...
class MainApp  : Application() {
    ...
    override fun onCreate() {
        ...
        areas.create(AreaModel(0, "Geography"))
        areas.create(AreaModel(1, "Culture"))
        areas.create(AreaModel(2, "Science"))

        themes.create(ThemeModel(0, "Marine biology", "", 2))
        themes.create(ThemeModel(1, "Mountains", "",0))
        themes.create(ThemeModel(2, "Rivers", "",0))
        themes.create(ThemeModel(3, "Dances", "",1))
        ...
        portions.create(PortionModel(1,"Carpathian Mountains",
            ...
            1))
        portions.create(PortionModel(2,"Danube",
            ...
            2))
        portions.create(PortionModel(3,"Hopak",
            ...
            3))
        portions.create(PortionModel(4,"Palyanytsya",
            ...
            4))
        portions.create(PortionModel(5,"Trembita",
            ...
            5))
        portions.create(PortionModel(6,"Kobza",
            ...
            5))
        portions.create(PortionModel(7,"Arsenalna (Kyiv Metro)",
